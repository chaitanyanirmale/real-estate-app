...
export default function CreateListing() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            if(image.length < 1) return setError('You must upload at least one image');
            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex gap-6 flex-wrap'>
                    ...
                    <div className='flex gap-2'>
                        <input 
                            type="checkbox" 
                            id='parking' className='w-5' onChange={handleChange} checked={formData.parking}/>
                ...
                <div className="flex flex-wrap gap-4">
                    <div className="flex items-center gap-2">
                        <input 
                            type="number" 
                            id='bedrooms' min='1' max='10' required
            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className="flex gap-4">
                    ...
                    <button onClick={handleImageUpload} disabled={uploading}
                        type='button' className='p-3 text-green-600 border border-green-600 rounded uppercase hover:shadow-lg disabled:opacity-80'>{uploading? 'Uploading' : 'Upload'}
                    </button>
                </div>
